                        ...
                        <div class="w-1/2 overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                            <div class="p-6 text-gray-900 dark:text-gray-100">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input name="title" value="{{ old('title', $offer->title) }}" type="text"
                                            required="required" class="my_input" placeholder="Title">
                                        @error('title')
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input name="price" value="{{ old('price', $offer->price) }}" type="number"
                                            min="0" required="required" class="my_input" placeholder="Price">
                                        @error('price')
                                            <p class="p-2 text-red-700">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="flex flex-col image-preview">
                                        ...
                                        <div class="flex items-center justify-center p-4">
                                            <img class="object-cover w-96 h-72 rounded-3xl" {{-- src="{{ asset(\App\Models\Offer::PLACEHOLDER_IMAGE) }}" --}}
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <textarea name="description" rows="5" class="my_input" placeholder="Description">{{ old('description', $offer->description) }}</textarea>
                                        @error('description')
                                            <p class="p-2 text-red-700">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <button
                                        class="flex items-center justify-center w-full px-4 py-3 text-white bg-green-500 rounded-md focus:outline-none">Update
                                    </button>
